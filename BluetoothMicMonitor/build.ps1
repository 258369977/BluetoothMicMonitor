...
# Fix MainWindow.cs Thickness for .NET 4.8
$mw = [System.IO.File]::ReadAllText("$PSScriptRoot\MainWindow.cs")
$mw = $mw.Replace('new Thickness(14, 0)', 'new Thickness(14, 0, 14, 0)')
$mw = $mw.Replace('new Thickness(6, 0)', 'new Thickness(6, 0, 6, 0)')
[System.IO.File]::WriteAllText("$PSScriptRoot\MainWindow.cs", $mw)

Push-Location $PSScriptRoot
$result = & $csc /target:winexe /langversion:5 /win32manifest:app.manifest /out:BluetoothMicMonitor.exe `
